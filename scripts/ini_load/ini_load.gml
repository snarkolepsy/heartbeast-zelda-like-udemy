function ini_load(){
	...
	// Prevent us from loading a non-existent save file
	...
	// Load room starting and position
	...
	// Loading the items
	global.item = ini_read_inventory("Player", "Equipment", []);
	
	// Loading the destroyed object list
